...
const fieldVariants = {
  ...
  visible: (i) => ({ opacity: 1, x: 0, transition: { delay: 0.3 + i * 0.1, duration: 0.4 } }),
}
        ...
        >
          ...
          >
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #7c5cfc, #fc5c9c)', boxShadow: '0 8px 24px rgba(124,92,252,0.4)' }}
            >
              M
            </div>
            <h1 className="font-syne text-3xl font-bold gradient-text">Welcome back</h1>
            <p className="text-white/40 text-sm mt-1 font-inter">Login to discover what matches your mood</p>
          </motion.div>
          ...
          <form onSubmit={handleLogin} className="space-y-4" noValidate>
            ...
            <motion.div custom={0} variants={fieldVariants} initial="hidden" animate="visible">
              <label htmlFor="login-email" className="block text-white/60 text-xs font-semibold uppercase tracking-widest mb-1.5">
                Email
              </label>
              <input
                id="login-email"
            ...
            <motion.div custom={1} variants={fieldVariants} initial="hidden" animate="visible">
              <label htmlFor="login-password" className="block text-white/60 text-xs font-semibold uppercase tracking-widest mb-1.5">
                Password
              </label>
          ...
          >
            ...
            <Link to="/register" className="text-brand-purple hover:text-brand-pink transition-colors font-medium">
              Register
            </Link>
          </motion.p>
        </div>
